...
<div class="col-lg-12">
    <div id="tableadvancedTabContent" class="tab-content">
        <div id="table-sorter-tab" class="tab-pane fade active in">
            <div class="row">
                <div class="col-lg-12"><h3 class="mtn" style="padding-left: 20px;"> {{ trans('translate.NAME_BRAND') }} </h3>
                ...
                <table class="table table-hover table-striped table-bordered table-advanced tablesorter">
                    <thead>
                        <tr style="text-align: center;">
                            ...
                            <th width="10%"> {{ trans('translate.NAME_BRAND') }}</th>
                            <th width="10%"> {{ trans('translate.CODE_BRAND') }}</th>
				...
				<?php foreach($datashow as $datas){ ?>
                                <tr>  
                                    ...
                                    <td>
                                        <a href="<?php echo url('admin/brand/delete');?>/<?php echo $datas->brand_id; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> </a>
                                        <a href="<?php echo url('admin/brand');?>/<?php echo $datas->brand_id; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> </a>
                                    </td>
                                 </tr> 
                            <?php } ?>           
                    </tbody>
