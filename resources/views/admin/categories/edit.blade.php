        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(array('url' => ['admin/category/update',$editdata->menu_id],'enctype'=>'multipart/form-data','file'=>'true','class'=>'form-horizontal','id'=>'popup-validation')) !!}
                                   ...
                                   <select name="parent" id="parent" class="form-control">
                                    <option value="0">{{ trans('translate.PLEASE_SELECT_SUB_CATEGORY') }}  </option>
                                       <?php foreach($model as $datas){ 
                                           if($datas->menu_id == $editdata->parent){
                                       ...
                                       <?php if($datas->parent==0){ ?>
                                                <option <?php echo $selected; ?> value="<?php echo $datas->menu_id;?>" ><?php echo $datas->menu_name_en;?> - <?php echo $datas->menu_name_kh;?></option>
                                            <?php } ?>
                            ...
                            <div class="form-group{{ $errors->has('parent_tab_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-7">
                                   <select name="parent_tab_id" id="parent_tab" class="form-control">
                                        ...
                                        <?php foreach($modeltab as $datatabs){?> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('menu_name_en') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="validate[required] form-control" name="menu_name_en" value="<?php echo $editdata->menu_name_en; ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('menu_name_kh') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="validate[required] form-control" name="menu_name_kh" value="<?php echo $editdata->menu_name_kh; ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('menu_code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-7">
                                    <input id="text" type="text" class="validate[required] form-control" name="menu_code" value="<?php echo $editdata->menu_code; ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('font_icon') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-7">
                                    <input id="text" type="text" class="form-control" name="font_icon" value="<?php echo $editdata->font_icon; ?>">
