        ...
        <div class="col-md-12 col-md-offset-0">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(array('url' => ['admin/product/update',$editdata->p_id],'enctype'=>'multipart/form-data','file'=>'true')) !!}
                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}"> 
                        ...
                        <div class="form-group{{ $errors->has('p_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <input id="p_name" type="text" class="form-control" name="p_name" value="<?php echo $editdata->p_name;?>">
                        ...
                        <div class="form-group{{ $errors->has('p_url') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="p_url" type="text" class="form-control" name="p_url" value="{{ old('<?php echo $editdata->p_url;?>') }}">
                                @if($errors->has('menu_name'))
                        ...
                        <div class="form-group{{ $errors->has('p_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">
                                <input id="p_code" type="text" class="form-control" name="p_code" value="<?php echo $editdata->p_code;?>">
                                @if($errors->has('menu_name'))
                                        <span style="color:red">{!!$errors->first('p_url')!!} </span>
                                @endif
                            </div>
                    ...
                    <div style="clear: both; margin-top: 30px;"></div>
                        <div class="form-group{{ $errors->has('p_image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">
                                <input id="p_image" type="file" class="form-control" name="p_image" value="{{ old('<?php echo $editdata->p_image;?>') }}">
                                @if($errors->has('images'))
                                        <span style="color:red">{!!$errors->first('p_image')!!} </span>
                                @endif
                            </div >
                            <div style="margin-top: 10px;" class="col-md-2"><?php echo $editdata->p_image;?></div>
                        </div>
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                               <select name="p_status" id="p_status" class="form-control">
                                    <option value="1" <?php if ($editdata->p_status==1) echo 'selected="selected"';?> ><?php echo "Publish"; ?></option>
                                    <option value="0" <?php if ($editdata->p_status==0) echo 'selected="selected"';?> ><?php echo "Unpublish"; ?></option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('p_ordering') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-2">
                                <input id="p_description" type="text" class="form-control" name="p_ordering" value="<?php echo $editdata->p_ordering;?>">
                        ...
                        <div style="margin-top: 30px;" class="form-group{{ $errors->has('p_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-11">
                                <textarea id="editor" name="p_description" ><?php echo $editdata->p_description;?> </textarea>
