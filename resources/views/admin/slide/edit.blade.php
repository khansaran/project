            ...
            <div class="panel panel-default">
				...
				<?php } ?>
                        ...
                        <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="category" type="text" class="validate[required] form-control" name="name_en" value="{{ $editdata->name_en }}">
                        ...
                        <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="validate[required] form-control" name="code" value="{{ $editdata->code }}">
